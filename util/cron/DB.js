...
DB.prototype.find = function(coll){
    //db.hairdressers.find( {$or:[{ "appointments": { $elemMatch: {slotType: {$ne:1}}}},{ "appointments": { $elemMatch: {slotType: {$ne:-2}}}}  ]} ).pretty()
    var _this = this;

	return new Promise(function (resolve, reject){
            var result = [];
            var cursor =_this.db.collection(coll).find( {$or:[{ "appointments": { $elemMatch: {slotType: {$ne:1}}}},{ "appointments": { $elemMatch: {slotType: {$ne:-2}}}}  ]} );            
