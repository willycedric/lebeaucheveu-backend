...
exports.getFreshUser = function() {
  return function(req, res, next) {
    req.app.db.models.Account.findById(req.user._id)
      .then(function(user) {
        if (!user) {
...
exports.verifyUser = function() {
  return function(req, res, next) {
    ...
    req.app.db.models.Account.findOne({email: email})
      .then(function(user) {
        if (!user) {
...
exports.signToken = function(id,username) {
  return jwt.sign(
    ...
    config.webToken.secrets.jwt,
    {expiresIn: config.webToken.expireTime}
  );
};
