angular.module('hairdresser.verification', ['security', 'services.utility', 'services.accountResource', 'directives.serverError', 'ui.bootstrap']);
angular.module('hairdresser.verification').config(['$routeProvider', function($routeProvider){
  $routeProvider
    .when('/hairdresser/verification', {
      templateUrl: 'hairdresser/verification/hairdresser-verification.tpl.html',
      ...
      resolve: {
        upsertVerificationToken: ['$q', '$location', 'accountResource', 'securityAuthorization', function($q, $location, restResource, securityAuthorization){
          //lazy upsert verification only for un-verified user, otherwise redirect to /hairdresser
          var redirectUrl;
    ...
    .when('/hairdresser/verification/:token', {
      resolve: {
        verify: ['$q', '$location', '$route', 'accountResource', 'securityAuthorization', function($q, $location, $route, restResource, securityAuthorization){
          //attemp to verify hairdresser only for un-verified user
          var redirectUrl;
          var promise = securityAuthorization.requireUnverifiedUser()
            .then(function(){
...
angular.module('hairdresser.verification').controller('HairdresserVerificationCtrl', [ '$scope', '$location', '$log', 'accountResource', 'security', 'utility',
